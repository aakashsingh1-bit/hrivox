  ...
  return (
    <div className="account-screen page-screen">
      ...
      <div className="balance-card">
        ...
        <small>Markets · Harf — see each game for min & payout</small>
      </div>
      ...
      <div className="account-list">
        <button type="button" onClick={() => onNavigate('play')}>
          <span>
            <ListOrdered size={17} /> Play & participate
          </span>
          <ChevronRight size={16} />
        </button>
        <button type="button" onClick={() => onNavigate('more')}>
          <span>
            <CircleHelp size={17} /> Help & information
          </span>
          <ChevronRight size={16} />
        </button>
        <button type="button" onClick={onOpenSettings}>
          <span>
            <Settings size={17} /> Sound & settings
          </span>
          <ChevronRight size={16} />
        </button>
      </div>
